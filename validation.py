           ...
           if panel == "Загрузка файлов":
              ...
              #в полулогарифмических координатах
                 ...
                 if checking_condition_cmax2 or (len(list_cmax_1_pk) == len(df.index.tolist()) and (st.session_state["agree_cmax2 - фк"] == False)):
                    ...
                    writer = pd.ExcelWriter("C:/Users/Павел/OneDrive/Рабочий стол/Статьи для валидации приложения/проекты_феникс/проекты_феникс/my_app_res_ph_07_BE_2024_T.xlsx", engine='xlsxwriter')
